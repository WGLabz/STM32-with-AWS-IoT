...
#define MBED_CONF_APP_LED_OFF                                                 1                                                                                                // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_APP_LED_ON                                                  0                                                                                                // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_APP_LED_PIN                                                 LED1                                                                                             // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_APP_MAIN_STACK_SIZE                                         4096                                                                                             // set by application
#define MBED_CONF_APP_USER_BUTTON                                             USER_BUTTON                                                                                      // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_APP_WIFI_DATAREADY                                          PE_1                                                                                             // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                                           df                                                                                               // set by application
...
#define MBED_CONF_APP_WIFI_SSID                                               df                                                                                               // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 ""                                                                                               // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 NONE                                                                                             // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "WGLABZ_Mobile"                                                                                  // set by application[DISCO_L475VG_IOT01A]
